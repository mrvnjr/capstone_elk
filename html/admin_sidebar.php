    ...
    <div class="dash-nav dash-nav-light bg-light">
            ...
            <nav class="dash-nav-list">
                ...
                <a href="subjects.php"class="dash-nav-item text-success"><i class="fas fa-plus-circle"></i>Subject</a>
                <a href="class.php"class="dash-nav-item text-success"><i class="fas fa-plus-circle"></i> Section</a>
