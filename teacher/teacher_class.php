				...
				?>
					<li id="del<?php echo $id; ?>">
						<a href="my_students.php<?php echo '?id='.$id; ?>">
								...
								<img src ="../uploads/thumbnails.jpg" width="114" height="120" class="img-polaroid" alt="">
						...
						<a href="#<?php echo $id; ?>" data-toggle="modal"><i class="fas fa-trash"></i> Remove</a>	
					
					</li>
				<?php include("delete_class_modal.php"); ?>
			<?php } }else{ ?>
				<div class="alert alert-info" role="alert"><i class="fas fa-info-circle"></i> No Class Currently Added</div>
			<?php  } ?>
		</ul>
	</div>
</div>
